...
from app.routers import administration, auth, patients
...
from app.models import token_revoque as token_revoque_model
from app.core.migrate import appliquer_migrations
from app.core.startup import creer_admin_par_defaut_si_absent

Base.metadata.create_all(bind=engine)
appliquer_migrations(engine)
